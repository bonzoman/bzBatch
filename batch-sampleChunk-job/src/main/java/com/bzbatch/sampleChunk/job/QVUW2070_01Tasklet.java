...
//            log.debug(StepExecution_Context_PUT_1);
            ...
            String manager = qvuw207001Query.selectManager("PRESIDENT");
            ...
            if ("D".equalsIgnoreCase(JOB_OPT)) { //삭제모드
                while ((inFileAu02Vo = fileReader.read()) != null) {
                    ...
                    try {
                        ...
                        //기존 건 delete
                        int deleteCount = qvuw207001Query.delete2080_01(inFileAu02Vo);
                ...
                while ((inFileAu02Vo = fileReader.read()) != null) {
                    ...
                    try {
                        ...
                        int insertCount = qvuw207001Query.insert2080_01(inFileAu02Vo);
