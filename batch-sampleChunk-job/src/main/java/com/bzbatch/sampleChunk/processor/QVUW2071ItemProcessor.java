...
public class QVUW2071ItemProcessor implements ItemProcessor<InFileAu02Vo, InFileAu02Vo> {
    ...
    public void retrieveManagerFromContext(StepExecution stepExecution) {
        log.debug("[QVUW2071ItemProcessor]  retrieveManagerFromContext ======");
    ...
    public InFileAu02Vo process(@NonNull InFileAu02Vo item) {
        count++;
        log.debug("[QVUW2071ItemProcessor]  process ======");
